...
function MeuComponente() {
  const [mostrarTextoWhatsapp, setMostrarTextoWhatsapp] = useState(false);

  const handleMouseEnterWhatsapp = () => {
    setMostrarTextoWhatsapp(true);
  };

  const handleMouseLeaveWhatsapp = () => {
    setMostrarTextoWhatsapp(false);
  };
  ...
  return (
    <>
      <a {...Whatsapp} style={{ textDecoration: "none" }}>
        <div
          className="col area17C reveal"
        ...
        >
          ...
          >
            <div className="card-body text-center">
              ...
              {mostrarTextoWhatsapp && (
                <>
                  <h6 className="fs-6 corTitulo3">
                    clique para contatar pelo Whatsapp
                  </h6>
                </>
              )}
            </div>
